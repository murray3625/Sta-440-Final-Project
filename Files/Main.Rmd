...
title: |
  ...
  <center> Drafted NCAA Quarterbacks from 2000-2019 </center>
...
**Note 1** - In all the dataset(s) used for these graphs, I renamed the Pac-10 to the Pac-12, as the conference changed names in 2011 with the addition of two schools, Colorado and Utah. 

**Note 2** - The red lines in **Figure 1**, **Figure 3**, and **Figure 4** are positioned at the mean value of the variable on the y-axis.  
